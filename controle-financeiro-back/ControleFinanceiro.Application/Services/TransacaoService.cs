...
namespace ControleFinanceiro.Application.Services
{
    public class TransacaoService
    {
        ...
        public async Task AdicionarAsync(TransacoesDTO dtO)
        {
        ...
        public async Task AtualizarAsync(int id, TransacoesDTO dto)
        {
        ...
        public async Task<List<TransacaoRespostaDTO>> ListarDoUsuarioAsync(int usuarioId, TipoCategoriaEnum? tipo)
        {
